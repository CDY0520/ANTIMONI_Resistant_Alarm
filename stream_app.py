...
with col1:
    ...
    if hospital_df is not None and community_df is not None:
        ...
        st.markdown("""
        <div class="responsive-box" style="background-color:#fef9f5; padding:10px; border-radius:16px; height: 370px; display: flex; align-items: center; justify-content: center;">
