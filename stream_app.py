...
with col2:
    st.markdown(class="responsive-box" "#### 🏥 병원 감염", unsafe_allow_html=True)
...
with col3:
    st.markdown(class="responsive-box" "#### 🌐 지역사회 감염", unsafe_allow_html=True)
...
with col1:
    st.markdown(class="responsive-box" "#### 🔔 통합 경보", unsafe_allow_html=True)
    st.markdown(" ")
    st.markdown(" ")
    st.markdown(" ")
    st.markdown(" ")
